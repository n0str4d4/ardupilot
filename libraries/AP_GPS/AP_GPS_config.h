...
#define AP_GPS_BLENDED_ENABLED 0 //AP_GPS_BACKEND_DEFAULT_ENABLED && defined(GPS_BLENDED_INSTANCE)
#endif
...
#define AP_GPS_DRONECAN_ENABLED 0 //AP_GPS_BACKEND_DEFAULT_ENABLED && HAL_ENABLE_DRONECAN_DRIVERS
  ...
  #define AP_GPS_GSOF_ENABLED 0 //AP_GPS_BACKEND_DEFAULT_ENABLED
#endif
...
#define HAL_MSP_GPS_ENABLED AP_GPS_BACKEND_DEFAULT_ENABLED && HAL_MSP_SENSORS_ENABLED
  ...
  #define AP_GPS_NMEA_UNICORE_ENABLED 0 //AP_GPS_NMEA_ENABLED
#endif
